...
heading5.innerHTML=productList[i].price
var details = document.createElement("div")
details.className="details"

details.append(heading3,heading4,heading5)

// -------------------------details class is created

var card = document.createElement("div")
card.className="card"
card.id =productList[i].id

// -------------------------card class is created

card.append(image,details)

// whole card is created in Js



var clothingContent = document.getElementById("clothing-content")
// clothingContent.append(card)

var accessoriesContent = document.getElementById("accessories-content")
...
if(productList[i].isAccessory === false){
  ...
  accessoriesContent.append(card)
}
